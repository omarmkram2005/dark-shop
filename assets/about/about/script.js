...
let vidBg = document.getElementById("vidOn");
let closeVid = document.getElementById("closeVid");
let vid = document.getElementById("vid");
document.getElementById("playVid").onclick = () => {
  ...
  setTimeout(() => {
    ...
    vid.innerHTML =
      '<div id="closeVid" class="absolute top-[-10%] text-3xl cursor-pointer hover:text-[#ffffff] text-[#ffffff7a] right-0 z-40">X </div> <iframe class=" bg-[#363636]" width="900" height="506" src="https://www.youtube.com/embed/udHV0Ott7Nw?si=oOanZrsdO-keWEdD" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe></div>';
  }, 50);
};
closeVid.onclick = () => {};
vidBg.addEventListener("click", function () {
  ...
  vid.style.transform = `translateY(400px)`;
  console.log(11);

  setTimeout(() => {
    vid.innerHTML =
      '<div id="closeVid" class="absolute top-[-10%] text-3xl cursor-pointer hover:text-[#ffffff] text-[#ffffff7a] right-0 z-40">X </div> <div class="w-[900px] h-[506px] bg-[#363636]"></div>';
